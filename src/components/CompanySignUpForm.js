                    ...
                    <form id="loginform" name="loginform" noValidate="validate">
                        <div className="container align-items-center">
                            <div className="col-sm-10">
                                ...
                                <div className="form-group">
                                    <h5><p className= "sansserif"><b>Password: </b></p><input className="form-control" value = {this.state.password} onChange={this.passwordChange} type="password" placeholder="********"/></h5>
                                </div>
